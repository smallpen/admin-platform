...
const menuItems = computed<MenuItem[]>(() => [
  ...
  },
  {
    ...
    show: has('user:list') || has('role:list') || has('permission:list') || has('activity_log:list') || has('announcement:list'),
    children: [
      ...
      { path: '/activity-logs', label: t('common.nav.activityLogs'),  show: has('activity_log:list') },
      { path: '/announcements', label: t('common.nav.announcements'), show: has('announcement:list') },
    ],
  },
  {
    key: 'settings',
    ...
    show: has('settings:view') || has('scheduled_task:list'),
    children: [
      { path: '/settings/maintenance', label: t('common.nav.maintenance'),   show: has('settings:view') },
      { path: '/scheduled-tasks',      label: t('common.nav.scheduledTasks'), show: has('scheduled_task:list') },
    ],
  },
  {
    key: 'website',
